...
function renderReactionsPanel(data) {
    ...
    if (data.pureLaughMessages > 0) {
        ...
        parts.push(`<div class="reaction-stat"><span class="reaction-emoji">😂</span><span class="reaction-label">ㅋㅋ·ㅎㅎ만</span><span class="reaction-value">${formatNumber(data.pureLaughMessages)}건 (${pct}%)</span></div>`);
    }
