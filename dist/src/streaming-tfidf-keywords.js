...
export function bm25Score(tf, df, corpusMessages, avgDl) {
...
function minPmiThreshold(corpusMessages) {
    if (corpusMessages < 500)
        return 3;
    if (corpusMessages < 10_000)
        return 3.5;
    return 4;
}
function isStutterBigram(label) {
    ...
    if (isDiscourseBigram(a, b))
        return true;
    return false;
}
function isDiscourseBigram(a, b) {
