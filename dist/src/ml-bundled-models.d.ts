...
export declare function isBundledGraniteEmbedModelReady(): boolean;
...
export declare function mergedMlModelsDir(): string;
...
export declare function isLocalBundledGraniteEmbedModel(modelId: string): boolean;
