...
export declare const HUB_KOREAN_KURE_V1 = "nlpai-lab/KURE-v1";
/** 다국어·한국어 검색 임베딩 — ultra·고RAM */
export declare const HUB_BGE_M3 = "BAAI/bge-m3";
/** 가용 RAM(GB) 이상이면 Hub KURE-v1 (번들 대신) */
export declare const SEMANTIC_HEADROOM_KURE_GB = 14;
/** 가용 RAM(GB) 이상이면 Hub BGE-M3 (ultra) */
export declare const SEMANTIC_HEADROOM_BGE_GB = 20;
/** balanced에서 KURE Hub — 번들 유지 하한 */
export declare const SEMANTIC_HEADROOM_KURE_BALANCED_GB = 16;
/** 다국어 임베딩 SOTA — IBM Granite R2 (97M, 384dim, 200+ 언어, 32K ctx) */
export declare const HUB_GRANITE_EMBED_97M = "ibm-granite/granite-embedding-97m-multilingual-r2";
/** 다국어 임베딩 flagship — IBM Granite R2 (311M, 768dim, Matryoshka) */
export declare const HUB_GRANITE_EMBED_311M = "ibm-granite/granite-embedding-311m-multilingual-r2";
/** 감정 분석 — KR-ELECTRA-small (2024, NSMC fine-tuned) */
export declare const HUB_KRELECTRA_NSMC = "snunlp/KR-ELECTRA-small";
/** 독성·공격 톤 — KcELECTRA toxic detector (fine-tuned) */
export declare const HUB_KCELECTRA_TOXICITY = "jinkyeongk/kcELECTRA-toxic-detector";
/** 레거시 독성·공격 톤 (base discriminator, 비권장) */
export declare const HUB_KCELECTRA_TOXICITY_LEGACY = "monologg/koelectra-base-v3-discriminator";
