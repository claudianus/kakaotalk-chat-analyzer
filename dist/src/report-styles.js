...
#s-wrapped, #s-personas, #s-chapters, #s-calendar { scroll-margin-top: 76px; }
    ...
    /* 짧은 기간(≤14주): 카드 너비에 맞게 주차 열을 균등 확장 */
    ...
    .gh-contrib--compact .gh-cal-months {
      grid-template-columns: repeat(var(--gh-weeks), minmax(0, 1fr));
    }
    ...
    .gh-contrib--compact .gh-cal-days {
      grid-template-rows: repeat(7, minmax(0, 1fr));
      align-content: stretch;
      height: 100%;
    }
    .gh-contrib--compact .gh-cal-days span {
      height: auto;
      min-height: 0;
    }
