...
export function analyzeHonorificStyle(text) {
    ...
    if (honorific > 0 && casual === 0)
        return "honorific";
    if (casual > 0 && honorific === 0)
        return "casual";
    return "neutral";
}
export function analyzeParticipantHonorific(messages) {
...
//# sourceMappingURL=honorific-analyzer.js.map