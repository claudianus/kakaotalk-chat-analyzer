...
export declare function resolveBurstDetectionMethod(): BurstDetectionMethod;
export declare function computeBurstDays(daily: DailyCount[], method?: BurstDetectionMethod): DailyCount[];
