...
export function countScriptChars(text: string): { hangul: number; latin: number } {
  return {
...
export function isPrimarilyKoreanText(corpus: string, messageCount: number): boolean {
...
export function isPrimarilyKoreanMessages(messages: string[]): boolean {
