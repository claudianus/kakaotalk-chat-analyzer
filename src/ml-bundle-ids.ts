...
/** KURE-v1 feature-extraction (~2.1GB ONNX, Release zip lazy) */
export const BUNDLED_KURE_MODEL_ID = "kca-kure-v1";

/** IBM Granite 97M multilingual R2 embedding (2026 SOTA, 390MB ONNX) */
export const BUNDLED_GRANITE_EMBED_MODEL_ID = "kca-granite-embed-97m";
