...
export function renderStorySections(data: ReportData): string {
  ...
  parts.push(`<section id="s-wrapped" class="kca-section wrapped-section kca-shot-block anim-enter" data-observe style="--enter-delay:0.02s" aria-label="대화 Wrapped">
  ...
  if (s.chapters.length > 1) {
    parts.push(`<section id="s-chapters" class="kca-section card kca-card--story kca-shot-block anim-enter" data-observe style="--enter-delay:0.045s">
      <h2>대화 챕터</h2>
  ...
  if (s.calendarWeeks.length > 0) {
    ...
    parts.push(`<section id="s-calendar" class="kca-section kca-shot-block anim-enter" data-observe style="--enter-delay:0.05s">
